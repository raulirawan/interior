                ...
                <div class="col-lg-12 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid w-100" src="{{ $blog->image }}" alt="{{ $blog->name }}">
                        </div>
                        ...
                        {{-- <div class="navigation-area">
                            <div class="row">
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('/frontend') }}/assets/img/post/preview.png" alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                        <a href="#">
                                ...
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('/frontend') }}/assets/img/post/next.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
