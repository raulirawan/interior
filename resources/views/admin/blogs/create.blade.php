...
@section('title', 'Page Create Blog')
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-header">Create Data Blog</div>
                <div class="card-body">
                    <form action="{{ route('admin.blogs.store') }}" method="post" id="form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
    ...
    @push('down-script')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', (event) => {
                ...
                // Combine into the format required for the input field
                const maxDateTime = `${year}-${month}-${day}T${hours}:${minutes}`;

                // Set the max attribute of the datetime-local input field
                document.getElementById('datetime').max = maxDateTime;
            });
            ClassicEditor
