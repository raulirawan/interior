    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-header">Edit Data Project</div>
                <div class="card-body">
                    <form action="{{ route('admin.projects.update', $project->id) }}" id="form" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ $project->name ?? null }}" name="name" placeholder="Enter Name"
                                        required>
                                    @error('name')
