...
@section('title', 'Page Edit Service')
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.services.update', $service->id) }}" id="form" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ $service->name ?? null }}" name="name" placeholder="Enter Name"
                                        required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-3" id="div-image-preview" style="display: block;">
                                        <h5>Image Preview:</h5>
                                        <img id="preview" src="{{ $service->image }}" alt="Image Preview"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="editor" class="form-control @error('description') is-invalid @enderror"
                                        id="description" cols="30" rows="40">{{ $service->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
